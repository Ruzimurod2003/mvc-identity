...
using mvcidentity.ServiceInterface;
using ServiceStack;
using ServiceStack.Auth;
using ServiceStack.Configuration;

[assembly: HostingStartup(typeof(mvcidentity.AppHost))]

namespace mvcidentity;

/// <summary>
/// To create Identity SQL Server database, change "ConnectionStrings" in appsettings.json
///   $ dotnet ef migrations add CreatemvcidentityIdentitySchema
...
public class AppHost : AppHostBase, IHostingStartup
{
    ...
    public AppHost() : base("mvcidentity", typeof(MyServices).Assembly) { }
